...
// just two ones added together. 12 is written 
// as XII, which is simply X + II. The 
// number 27 is written as XXVII, 
// which is XX + V + II.

// Roman numerals are usually written largest to smallest 
// from left to right. However, the numeral for four 
// is not IIII. Instead, the number four is written 
// as IV. Because the one is before the five we 
// subtract it making four. The same principle 
